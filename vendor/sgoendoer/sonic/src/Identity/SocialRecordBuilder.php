...
use sgoendoer\Sonic\Identity\TrustorBuilder;
...
class SocialRecordBuilder
{
	...
	public static function buildFromJSON($json)
	{
		...
		if(!property_exists($jsonObject, 'trustors'))
			throw new SocialRecordFormatException('SocialRecord: Property trustors is missing!');
		...
		foreach($jsonObject->trustors as $tc)
		{
			$trustorsList[] = TrustorBuilder::buildFromJSON($tc);
		}
	...
	public function trustors($trustorsList = NULL){
		if($trustorsList == NULL)
			$this->trustors = array();
		else
	...
	/**
	 * Get the value for the parameter trustors
	 *
	 * @return The trustors (array)
	 */
